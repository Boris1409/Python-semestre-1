...
function calcularPedido() {
    ...
    const cant_hamburguesa = parseInt(phamburguesa.value) || 0;
    const cant_pizza = parseInt(ppizza.value) || 0;
    const cant_hotdog = parseInt(photdog.value) || 0;
    const cant_ensalada = parseInt(pensalada.value) || 0;
    const cant_papasfritas = parseInt(ppapasfritas.value) || 0;
    ...
    resultado += cant_hamburguesa * 3000;
    resultado += cant_pizza * 4200;
    resultado += cant_hotdog * 2500;
    resultado += cant_ensalada * 1600;
    resultado += cant_papasfritas * 2000;
